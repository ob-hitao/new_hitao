...
const SERVER = "/api",
      ...
      JD_SERVER = "http://api.onebound.cn/jd/api_call.php?key=test_api_key&secret=ob8899.",
      BIYAO_SERVER = "http://api.onebound.cn/biyao/api_call.php?key=test_api_key&secret=ob8899.";
...
const API =
{
    ...
    //必要商品
    DETAILS_BIYAO: BIYAO_SERVER + '&api_name=item_get',
    //商品_JD
